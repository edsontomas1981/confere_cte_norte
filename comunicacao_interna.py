...
def imprimir_ci(ci_num,destinatario,manifesto_numero,motorista,valor_a_ser_pago,origem_destino,data,observacao=''):
    ...
    story.append(Paragraph(f"Comunicacao Interna Nº {ci_num}", h3))
    ...
    texto = f"{destinatario},<br /><br />" \
            f"Estamos enviando o manifesto de transporte de cargas nº {manifesto_numero}. Este manifesto inclui conhecimentos de frete.<br /><br />" \
            f"De acordo com este manifesto, solicitamos o pagamento de R$ {valor_a_ser_pago} ao motorista {motorista}, referente à Ordem de Pagamento.<br /><br />" \


    observacao =f"{observacao}.<br /><br />" \
